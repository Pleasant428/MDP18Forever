...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendMDFBth = findViewById(R.id.sendMDFBtn);
                ...
                if (msg.substring(0, 7).equals("Android")) {
                    ...
                    switch (filteredMsg[2]) {
                        ...
                        case "hex":
                            ...
                            try {
                                mapDescriptor = delimiterMsg(filteredMsg[3], ",");
                                mapDescriptor[0] = mapDescriptor[0].toUpperCase();
                                mapDescriptor[1] = mapDescriptor[1].toUpperCase();
                                String stringOne = "Part1: "+mapDescriptor[0];
                                String stringTwo = "Part2: "+mapDescriptor[1];
                                md5ExplorationText.setText(stringOne);
                                md5ObstacleText.setText(stringTwo);
                                robotStatus.setText(R.string.Robot_Idle);
                            }
                            catch (Exception e){
                                e.printStackTrace();
                ...
                if (connectedDevice == null) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(MainActivity.this, "STARTING EXPLORATION...",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }, 1000);
            ...
            public void onClick(View arg0) {
                ...
                if (connectedDevice == null) {
                    ...
                    if (wayPoint[0] == -1 && wayPoint[1] == 20) {
                        Toast.makeText(MainActivity.this, "Please Select Waypoint!",
                                Toast.LENGTH_SHORT).show();
                    }
                    //START SHORTEST PATH
                    else {
    ...
    public void onClickSetWaypoint() {
        ...
        waypoint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Toast.makeText(MainActivity.this, "Select Waypoint for Shortest Path",
                        Toast.LENGTH_SHORT).show();
 ...
 */
    ...
    */
    public void onClickSendMDFBth() {

        sendMDFBth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (connectedDevice == null) {
                    ...
                    if(mapDescriptor != null) {
                        ...
                        String navi = "Part1=" + mapDescriptor[0] + "|Part2=" + mapDescriptor[1];
                        byte[] bytes = navi.getBytes(Charset.defaultCharset());
                        BluetoothChat.writeMsg(bytes);
                        Toast.makeText(MainActivity.this, "MDF String Sent!!",
                                Toast.LENGTH_SHORT).show();
                    }
                    else{
                        Toast.makeText(MainActivity.this, "No MDF String Detected!!",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
